    ...
    <section> 
        <div class="abt2">
            <div class="abt-text-contain2">
                ...
                <ul>
                    <li>Integrated with our dedicated SMTP server for Bulk Mailing.</li>
                    <li>Capable to send 100000+ bulk mails per day.</li>
                    <li>Automatic Bulk Mail / Newsletter Subscribe and Unsubscribe option.</li>
                    <li>Automatically delete bounced mails from your bulk mailing database / list.</li>
                    <li>You will get detailed mail read or open report for each mail bulk mailing process.</li>
                    <li>You can send HTML based Bulk Emails or Newsletters.</li>
